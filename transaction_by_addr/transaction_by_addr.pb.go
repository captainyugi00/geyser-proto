...
var file_transaction_by_addr_proto_rawDesc = []byte{
	...
	0x54, 0x53, 0x10, 0x35, 0x42, 0x1c, 0x5a, 0x1a, 0x67, 0x65, 0x79, 0x73, 0x65, 0x72, 0x2f, 0x74,
	0x72, 0x61, 0x6e, 0x73, 0x61, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x5f, 0x62, 0x79, 0x5f, 0x61, 0x64,
...
func file_transaction_by_addr_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_transaction_by_addr_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_transaction_by_addr_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_transaction_by_addr_proto_msgTypes[2].Exporter = func(v any, i int) any {
			switch v := v.(*Memo); i {
			case 0:
				return &v.state
			case 1:
		...
		file_transaction_by_addr_proto_msgTypes[3].Exporter = func(v any, i int) any {
		...
		file_transaction_by_addr_proto_msgTypes[4].Exporter = func(v any, i int) any {
		...
		file_transaction_by_addr_proto_msgTypes[5].Exporter = func(v any, i int) any {
		...
		file_transaction_by_addr_proto_msgTypes[6].Exporter = func(v any, i int) any {
		...
		file_transaction_by_addr_proto_msgTypes[7].Exporter = func(v any, i int) any {
